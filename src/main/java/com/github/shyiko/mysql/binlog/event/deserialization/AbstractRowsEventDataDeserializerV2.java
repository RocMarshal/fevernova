...
public abstract class AbstractRowsEventDataDeserializerV2<T extends EventData> implements EventDataDeserializer<T> {
    ...
    protected Long asUnixTime(int year, int month, int day, int hour, int minute, int second, int millis) {
        ...
        return AbstractRowsEventDataDeserializer.UnixTime.from(year, month, day, hour, minute, second, millis);
    }
